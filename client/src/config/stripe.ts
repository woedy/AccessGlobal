...
export const STRIPE_CONFIG = {
  ...
  // URLs
  SUCCESS_URL: import.meta.env.VITE_SUCCESS_URL || 'http://localhost:5174/donate/success?session_id={CHECKOUT_SESSION_ID}',
  CANCEL_URL: import.meta.env.VITE_CANCEL_URL || 'http://localhost:5174/donate',
