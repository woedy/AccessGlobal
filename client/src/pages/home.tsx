...
import { ChevronDown, Heart, Users, Globe, Leaf, TrendingUp, Activity, Sprout, Zap, Cpu } from 'lucide-react';
...
const FloatingElements = () => (
  <div className="absolute inset-0 overflow-hidden pointer-events-none">
    ...
    <div className="absolute top-1/3 right-1/4 w-3 h-3 bg-blue-400 rounded-full animate-bounce opacity-60" style={{animationDelay: '1s'}}></div>
    <div className="absolute bottom-1/3 left-1/3 w-2 h-2 bg-green-400 rounded-full animate-pulse opacity-70" style={{animationDelay: '2s'}}></div>
    <div className="absolute top-1/2 right-1/3 w-3 h-3 bg-purple-400 rounded-full animate-bounce opacity-60" style={{animationDelay: '0.5s'}}></div>
  </div>
);
...
const ProgramCard = ({ icon: Icon, title, description, color, image }) => (
  <div className="group bg-white rounded-2xl shadow-lg overflow-hidden hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2">
    <div className="relative overflow-hidden">
      ...
      <div className={`absolute top-4 left-4 p-3 rounded-full bg-${color}-500 text-white shadow-lg`}>
        <Icon size={24} />
      </div>
    </div>
    <div className="p-6">
  ...
  const programs = [
    {
      ...
      description: "Scholarships, digital literacy, school infrastructure, and teacher training in underserved regions.",
      color: "blue",
    ...
    },
    {
      ...
      description: "Community-based sustainability projects: tree planting, clean water access, and waste management.",
      color: "green",
    ...
    },
    {
      ...
      description: "Skills training, microfinance support, and mentorship for youth and women entrepreneurs.",
      color: "purple",
    ...
    },
    {
      ...
      description: "Mobile clinics, health awareness programs, and partnerships for medicine and medical aid delivery.",
      color: "red",
    ...
    },
    {
      ...
      description: "Modern farming techniques, crop management, and sustainable agriculture practices to boost productivity.",
      color: "amber",
    ...
    },
    {
      ...
      description: "Solar power installations, wind energy projects, and clean energy access for remote communities.",
      color: "yellow",
    ...
    },
    {
      ...
      description: "Smart farming solutions, precision agriculture, and technology integration for modern farming practices.",
      color: "cyan",
    ...
    <div className="overflow-x-hidden">
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div 
          ...
          style={{
            backgroundImage: "url('https://images.pexels.com/photos/8542360/pexels-photo-8542360.jpeg')"
          }}
        ></div>
        ...
        <div className={`relative z-20 text-center max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 transform transition-all duration-1000 ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
          <div className="mb-8">
            <div className="inline-block px-6 py-2 bg-yellow-500/20 rounded-full border border-yellow-500/30 backdrop-blur-sm mb-6">
              <span className="text-yellow-400 font-semibold">Making Impact Worldwide</span>
            </div>
          </div>
          ...
          <p className="text-xl md:text-2xl text-gray-200 mb-6 max-w-4xl mx-auto leading-relaxed">
            We believe in a world where every individual, regardless of background or geography, 
            has the opportunity to thrive and unlock their potential.
          </p>
      ...
      <section className="py-20 bg-gradient-to-r from-blue-600 via-purple-600 to-indigo-600 text-white relative overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-xl opacity-90">Numbers that tell our story of transformation</p>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <p className="text-xl text-gray-700 leading-relaxed mb-8">
                To create pathways to opportunity by breaking down barriers in underserved communities 
                and promoting equitable access to tools that change lives. Access Global Foundation is 
                committed to unlocking potential and opening doors — socially, economically, and 
                educationally — across the globe.
              </p>
              ...
              <div className="bg-white p-8 rounded-2xl shadow-xl border-l-4 border-blue-500">
                ...
                <cite className="text-blue-600 font-bold">- Access Global Foundation</cite>
              </div>
            </div>
      ...
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-20">
            ...
            <h2 className="text-4xl md:text-5xl font-black text-gray-900 mb-6">Our Programs</h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
              Comprehensive initiatives designed to address critical needs and create lasting impact across multiple sectors
            </p>
          </div>
      ...
      <section className="py-24 bg-gradient-to-r from-blue-600 via-purple-600 to-indigo-600 text-white relative overflow-hidden">
        ...
        <div className="relative max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="mb-8">
            <div className="inline-block px-6 py-2 bg-yellow-500/20 rounded-full border border-yellow-500/30 backdrop-blur-sm mb-6">
              <span className="text-yellow-400 font-semibold">Join Our Movement</span>
            </div>
          </div>
          ...
          <p className="text-xl mb-12 opacity-90 max-w-3xl mx-auto leading-relaxed">
            ...
            Together, we can build a more accessible and equitable future for all.
          </p>
          ...
          <div className="mt-16 grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
            <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6">
              ...
              <div className="opacity-90">Can provide school supplies for 10 children</div>
            </div>
            <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6">
              <div className="text-2xl font-bold mb-2">$100</div>
              <div className="opacity-90">Can fund a micro-loan for a small business</div>
            </div>
            <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6">
              <div className="text-2xl font-bold mb-2">$200</div>
              <div className="opacity-90">Can sponsor a farmer's training program</div>
            </div>
          </div>
        </div>
      </section>
