          ...
          <div className="bg-white rounded-lg shadow p-6 h-fit">
            ...
            <div className="mt-6 space-y-3">
              <div>
                ...
                <input
                  type="text"
                  className="mt-1 w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-amber-500 focus:border-amber-500"
